...
class Layer():
    ...
    def __intialise_neurons(self, number_of_neurons):
        neurons = []
        y = self.__calculate_top_margin_so_layer_is_centered(number_of_neurons)+0.1
    ...
    def __line_between_two_neurons(self, neuron1, neuron2):
        ...
        line = pyplot.Line2D((neuron1.x - neuron_radius, neuron2.x + neuron_radius), (neuron1.y, neuron2.y))
